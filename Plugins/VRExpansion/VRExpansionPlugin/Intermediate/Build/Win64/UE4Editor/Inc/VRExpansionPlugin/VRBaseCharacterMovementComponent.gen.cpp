...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFVRMoveActionContainer
{
	...
	DEFINE_FUNCTION(UVRBaseCharacterMovementComponent::execPerformMoveAction_SetRotation)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->PerformMoveAction_SetRotation(Z_Param_NewYaw,EVRMoveActionVelocityRetention(Z_Param_VelocityRetention),Z_Param_bFlagGripTeleport);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UVRBaseCharacterMovementComponent::execPerformMoveAction_SnapTurn)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->PerformMoveAction_SnapTurn(Z_Param_SnapTurnDeltaYaw,EVRMoveActionVelocityRetention(Z_Param_VelocityRetention),Z_Param_bFlagGripTeleport);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVRBaseCharacterMovementComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotation, "PerformMoveAction_SetRotation" }, // 2753836088
		{ &Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SnapTurn, "PerformMoveAction_SnapTurn" }, // 654545118
	...
	IMPLEMENT_CLASS(UVRBaseCharacterMovementComponent, 3789817129);
