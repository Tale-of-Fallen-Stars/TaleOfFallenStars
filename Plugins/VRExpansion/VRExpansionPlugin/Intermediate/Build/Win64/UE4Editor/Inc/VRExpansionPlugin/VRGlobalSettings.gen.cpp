...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFBPVRControllerProfile
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBPVRControllerProfile_Statics::NewProp_ActionOverrides_MetaData[] = {
		{ "Category", "ControllerProfiles" },
		{ "Comment", "// Setting action mappings here will override the equivalent bindings on profile load\n// As of 4.24 these do nothing, they are left for a few versions as a reference of old bindings\n// #TODO: Delete around 4.26\n" },
		{ "ModuleRelativePath", "Public/VRGlobalSettings.h" },
		{ "ToolTip", "Setting action mappings here will override the equivalent bindings on profile load\nAs of 4.24 these do nothing, they are left for a few versions as a reference of old bindings\n#TODO: Delete around 4.26" },
	};
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FBPVRControllerProfile_Statics::NewProp_ActionOverrides = { "ActionOverrides", nullptr, (EPropertyFlags)0x0010000080010001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBPVRControllerProfile, ActionOverrides), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FBPVRControllerProfile_Statics::NewProp_ActionOverrides_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBPVRControllerProfile_Statics::NewProp_ActionOverrides_MetaData)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBPVRControllerProfile_Statics::NewProp_AxisOverrides_MetaData[] = {
		{ "Category", "ControllerProfiles" },
		{ "Comment", "// Setting an axis value here with key bindings will override the equivalent bindings on profile load\n// As of 4.24 these do nothing, they are left for a few versions as a reference of old bindings\n// #TODO: Delete around 4.26\n" },
		{ "ModuleRelativePath", "Public/VRGlobalSettings.h" },
		{ "ToolTip", "Setting an axis value here with key bindings will override the equivalent bindings on profile load\nAs of 4.24 these do nothing, they are left for a few versions as a reference of old bindings\n#TODO: Delete around 4.26" },
	};
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FBPVRControllerProfile_Statics::NewProp_AxisOverrides = { "AxisOverrides", nullptr, (EPropertyFlags)0x0010000080010001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBPVRControllerProfile, AxisOverrides), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FBPVRControllerProfile_Statics::NewProp_AxisOverrides_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBPVRControllerProfile_Statics::NewProp_AxisOverrides_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FBPVRControllerProfile_Hash() { return 1310873798U; }
...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFActionMappingDetails
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FActionMappingDetails_Statics::Struct_MetaDataParams[] = {
		...
		{ "Comment", "// As of 4.24 these do nothing, they are left for a few versions as a reference of old bindings\n// #TODO: Delete around 4.26\n" },
		{ "ModuleRelativePath", "Public/VRGlobalSettings.h" },
		{ "ToolTip", "As of 4.24 these do nothing, they are left for a few versions as a reference of old bindings\n#TODO: Delete around 4.26" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FActionMappingDetails_Statics::NewProp_ActionMappings_MetaData[] = {
		{ "Category", "Input" },
		{ "Comment", "// List of all axis key mappings that correspond to the axis name in the containing map \n" },
		{ "ModuleRelativePath", "Public/VRGlobalSettings.h" },
		{ "ToolTip", "List of all axis key mappings that correspond to the axis name in the containing map" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FActionMappingDetails_Statics::NewProp_ActionMappings = { "ActionMappings", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActionMappingDetails, ActionMappings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FActionMappingDetails_Statics::NewProp_ActionMappings_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActionMappingDetails_Statics::NewProp_ActionMappings_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FActionMappingDetails_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActionMappingDetails_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FActionMappingDetails_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActionMappingDetails_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FActionMappingDetails_Hash() { return 2280216092U; }
...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFAxisMappingDetails
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAxisMappingDetails_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Category", "VRGlobalSettings" },
		{ "Comment", "/*namespace ControllerProfileStatics\n{\n\x09static const FTransform OculusTouchStaticOffset(FRotator(-70.f, 0.f, 0.f));\n}*/// As of 4.24 these do nothing, they are left for a few versions as a reference of old bindings\n// #TODO: Delete around 4.26\n" },
		{ "ModuleRelativePath", "Public/VRGlobalSettings.h" },
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAxisMappingDetails_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAxisMappingDetails_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FAxisMappingDetails_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAxisMappingDetails_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAxisMappingDetails_Hash() { return 1072385600U; }
